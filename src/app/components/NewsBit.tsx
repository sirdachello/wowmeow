...
export default function NewsBit({info}: {info: {title: string, date: string, description: string}}) {
    return (
        <div className="flex [clip-path:polygon(0%_0,98%_0,100%_100%,0_100%)] bg-customWhite overflow-hidden">
        <Image src={cyberCatsThumb} height={242} alt="cybercats: world logo" className="[clip-path:polygon(0%_0,95%_0,100%_100%,0_100%)] object-cover overflow-visible hidden min-lg:flex min-w-[326px]"/>
